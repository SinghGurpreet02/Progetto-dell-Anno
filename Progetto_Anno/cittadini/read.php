...
require_once("../models/cittadinos.php");
require_once("../inc/sanitize.inc.php");
require_once("../inc/responsemessage.inc.php");
require_once("../inc/tokenvalator.inc.php"); // OPZIONALE per rispondere solo ad utenti autenticati con token
...
if(isset($_GET['ID_cittadini']))	// Passare in GET (querystring) la chiave (se POST vedere file search.php)
	$result = $cittadini->read($_GET['ID_cittadini']);
else
