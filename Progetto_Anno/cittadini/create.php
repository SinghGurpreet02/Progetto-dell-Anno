...
if(
	...
	if($cittadini->create()){
		...
		$rspMsg = new Responsemessage("cittadini$cittadini creato correttamente", $cittadini->ID_cittadini);
	} else {
		http_response_code(503); //503 servizio non disponibile
		$rspMsg = new Responsemessage("Impossibile creare il cittadini$cittadini", -1);
		// echo json_encode(array("message" => "Impossibile creare il cittadini$cittadini"));
	}
	
} else {
	http_response_code(400); //400 bad request
	$rspMsg = new Responsemessage("Impossibile creare il cittadini$cittadini i dati sono incompleti", -1);
